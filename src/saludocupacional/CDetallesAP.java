...
public class CDetallesAP extends JInternalFrame {
    ...
    public void procesoantfam() {
        ...
        else if (ObjACF.JCHCardiopatias.isSelected() == true && ObjACF.swcardiopat == 1) {
            ObjACF.JTFCardiopatias.setText(JEDPdetAP.getText());
            ObjACF.swcardiopat = 0;
        }//cierra if de Cardiopatia
        else if (ObjACF.JCHCancer.isSelected() == true && ObjACF.swcancer == 1) {
            ObjACF.JTFCancer.setText(JEDPdetAP.getText());
            ObjACF.swcancer = 0;
        }//cierra if de Cancer
        else if (ObjACF.JCHOtros.isSelected() == true && ObjACF.swotros == 1) {
            ObjACF.JTFOtros.setText(JEDPdetAP.getText());
            ObjACF.swotros = 0;
        }//cierra if de Otros
        else if (ObjACF.JCHDiabet.isSelected() == true && ObjACF.swdiab == 1) {
            ObjACF.JTFDiab.setText(JEDPdetAP.getText());
            ObjACF.swdiab = 0;
        }//cierra if de diabetes
        else if (ObjACF.JCHHta.isSelected() == true && ObjACF.swhta == 1) {
            ObjACF.JTFHta.setText(JEDPdetAP.getText());
            ObjACF.swhta = 0;
        }//cierra if de HTA//cierra el else de HTA//cierra el else de diabetes// cierra el else de cancer//cierra el else de Cardiopatias//ciera else de epilepsia
        this.dispose();
    ...
    public void procesors() {
        ...
        else if (frameRSystem.JRDisuria.isSelected() == true && frameRSystem.swdisuria == 1) {
            frameRSystem.JFTDisuria.setText(JEDPdetAP.getText());
            frameRSystem.swdisuria = 0;
        }//cierra el if de disuria
        else if (frameRSystem.JRHematuria.isSelected() == true && frameRSystem.swhematuria == 1) {
            frameRSystem.JFTHematuria.setText(JEDPdetAP.getText());
            frameRSystem.swhematuria = 0;
        }//cierra el if de hematuria
        else if (frameRSystem.JRTrantCicloMestr.isSelected() == true && frameRSystem.swtransciclomestrual == 1) {
        ...
        else if (frameRSystem.JRAlteracionSensib.isSelected() == true && frameRSystem.swealteraciosensibilidad == 1) {
        ...
        else if (frameRSystem.JRParentestesias.isSelected() == true && frameRSystem.swparestesias == 1) {
            frameRSystem.JFTParestesias.setText(JEDPdetAP.getText());
            frameRSystem.swparestesias = 0;
        }//cierra el if de parestesias
        else if (frameRSystem.JRCervicalgia.isSelected() == true && frameRSystem.swcervicalgias == 1) {
            frameRSystem.JFTCervicalgia.setText(JEDPdetAP.getText());
            frameRSystem.swcervicalgias = 0;
        }//cierra el if de cervicalgias
        else if (frameRSystem.JRDorsalgia.isSelected() == true && frameRSystem.swdorsalgia == 1) {
            frameRSystem.JFTDorsalgia.setText(JEDPdetAP.getText());
            frameRSystem.swdorsalgia = 0;
        }//cierra el if de dorsalgias
        else if (frameRSystem.JRLumbalgia.isSelected() == true && frameRSystem.swlumbalgia == 1) {
            frameRSystem.JFTLumbalgia.setText(JEDPdetAP.getText());
            frameRSystem.swlumbalgia = 0;
        }//cierra el if de lumbalgias
        else if (frameRSystem.JRIncapacitante.isSelected() == true && frameRSystem.swincapacitante == 1) {
            frameRSystem.JRIncapacitante.setText(JEDPdetAP.getText());
            frameRSystem.swincapacitante = 0;
        }//cierra el if de incapacitante
        else if (frameRSystem.JRCoronaria.isSelected() == true && frameRSystem.swcoronaria == 1) {
            frameRSystem.JFTCoronaria.setText(JEDPdetAP.getText());
            frameRSystem.swcoronaria = 0;
        }//cierra el if de coronaria
        else if (frameRSystem.JRArritmia.isSelected() == true && frameRSystem.swarritmia == 1) {
            frameRSystem.JFTArritmia.setText(JEDPdetAP.getText());
            frameRSystem.swarritmia = 0;
        }//cierra el if de arritmia
        else if (frameRSystem.JRHa.isSelected() == true && frameRSystem.swHA == 1) {
            frameRSystem.JFTha.setText(JEDPdetAP.getText());
            frameRSystem.swHA = 0;
        }//cierra el if de arritmia//cierra el else de HA//cierra el else de arritmia //cierra el else de coronora //cierra el else incapacitante //cierra el else de lumbalgias//cierra el else de dorsalgias//cierra el else de cervicalgias //cierra el else de parestesias//cierra el else limitacion funcional // cierra el else de tendinitis //cierra el else de artralgias//cierra el else de tinitus //cierra el else de rinorrea //cierra el else obstruccion nasal //cierra el else de hipoacusia//cierra el else de epistaxis//  cierra el else de disfonia //cierra el else de xpectoracion //cierra el else de dolor toraxico//cierra el else de tos//cierra el else de ojo rojo //cierra el else de lagrimeo//cierra el else de visionborrosa //cierra el else de cansancio//cierra el else de ardorprurito//cierra el el else de vertigo //cierra el else de alteracion motora //cierra el else alteracionsencibilidad//cierra el else de alteracionmemoria// cierra el else de cefalea //cierra el else de tenesmovesical//cierra el else de polaquiuria //cierra el else de nicturia//cierra el else de transtornos ciclo mestrual//cierra el else de hematuria//cierra el else de disuria//cierra el else de disminucioncalibre //cierra el else de dispepsia//cierra el else de prurito//cierra el else de sequedad//  cierra el else de brote.//cierra el else de hiperhidrosis//cierra el else de sangrado//cierra el else de diarrea//cierra el else de estrenimiento//cierra el el else de epigastraiguia //cierra el else de dolor abdominal//cierra el else de disnea//cierra el else de sincope//cierra el else de palpitaciones//cierra el else de lipotimia//cierra el else del dolor precordial
        this.dispose();
    ...
    public void editorproceso() {
        if (swframe == 0) {
            ...
            procesoef();
        }//cierra el else cuando el swframe no es 0 ni 1//cierra el else del swframe=0
