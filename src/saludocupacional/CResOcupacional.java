...
public class CResOcupacional extends JInternalFrame {
    ...
    private void jbInit() throws Exception {
        ...
        JRAptoCargo.addActionListener(new CResOcupacional_JRAptoCargo_actionAdapter(this));
        ...
        JRTAptoRest.addActionListener(new CResOcupacional_JRTAptoRest_actionAdapter(this));
        ...
        JRBAplazado.addActionListener(new CResOcupacional_JRBAplazado_actionAdapter(this));
