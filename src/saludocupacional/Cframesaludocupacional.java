...
public class Cframesaludocupacional extends JFrame {
    ...
    private void jbInit() throws Exception {
        ...
        JMINmuniz.addActionListener(new Cframesaludocupacional_JMINmuniz_actionAdapter(this));
        JMHabit.setFont(new java.awt.Font("Arial", Font.BOLD, 11));
        JMHabit.setToolTipText("");
        JMHabit.setText("HABITOS");
        JMHabit.addActionListener(new Cframesaludocupacional_JMHabit_actionAdapter(this));
        JMPatologias.setFont(new java.awt.Font("Arial", Font.BOLD, 11));
        JMPatologias.setText("PATOLOGIAS");
        JMPatologias.addActionListener(new Cframesaludocupacional_JMPatologias_actionAdapter(this));
        ...
        JMParaclinicos.addActionListener(new Cframesaludocupacional_JMParaclinicos_actionAdapter(this));
        jMenu2.setFont(new java.awt.Font("Arial", Font.BOLD, 11));
        ...
        JMLateralidad.addActionListener(new Cframesaludocupacional_JMLateralidad_actionAdapter(this));
        JMTratamiento.setFont(new java.awt.Font("Arial", Font.BOLD, 11));
        JMTratamiento.setText("TRATAMIENTO");
        JMTratamiento.addActionListener(new Cframesaludocupacional_JMTratamiento_actionAdapter(this));
        JMReimprimir.setFont(new java.awt.Font("Arial", Font.BOLD, 11));
        JMReimprimir.setText("REIMPRIMIR");
        JMReimprimir.addActionListener(new Cframesaludocupacional_JMReimprimir_actionAdapter(this));
        JMEdicion.setFont(new java.awt.Font("Arial", Font.BOLD, 11));
        JMEdicion.setText("EDICION");
        JMEdicion.addActionListener(new Cframesaludocupacional_JMEdicion_actionAdapter(this));
        ...
        JMHistoriaOcupacional.addActionListener(new Cframesaludocupacional_JMHistoriaOcupacional_actionAdapter(this));
        JMGinecologia.setFont(new java.awt.Font("Arial", Font.BOLD, 11));
        JMGinecologia.setText("GINECOLOGIA");
        JMGinecologia.addActionListener(new Cframesaludocupacional_JMGinecologia_actionAdapter(this));
...
//      ppaljframe.getMaximumSize();
    ...
    public int guardardatosusuarios(CIngreso gingresoPM) throws SQLException {
        ...
        if (objvalidarGHC.validarcombonulo(gingresoPM.JCBBarrio) == 0) {
            ...
            guardarbarrio(gingresoPM.JFTBarrio.getText());
        ...
        if (objvalidarGHC.validarcombonulo(gingresoPM.JCBOcupacion) == 1) {
            ...
            guardarocupacion(gingresoPM.JFTOcup.getText());
        ...
        if (objvalidarGHC.validarcombonulo(gingresoPM.JCBEps) == 0) {
            ...
            guardareps(gingresoPM.JFTEps.getText());
        ...
        if (objvalidarGHC.validarcombonulo(gingresoPM.JCBIps) == 0) {
            ...
            guardarips(gingresoPM.JFTIps.getText());
        ...
        try {
            ...
            cadsqlhc = "insert into datosusuarios (NoHC_du,IdDocumentodeIdentificacion_du,Documento_du,PrimerApellido_du,SegundoApellido_du,PrimerNombre_du,SegundoNombre_du,FechadeNacimiento_du,idtipoedad_du,edad_du,IdSexo_du,IdEstadoCivi_du,NumHijos_du,IdMunicipionatural,IdDepartamentonatural_du,IdMunicipioprocedente_du,IdDepartamentoprocedente_du,idzonares_du,DireccionResidencia_du,Barrio_du,idtipoescolaridad_du,profesion_du,TelefonoCelular_du,idocupacion_du,ideps_du,idips_du,foto_du)  values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public int buscaridpaciente(String ndoc) {
        ...
        int ultima = 0;
        String cadDU;
        cadDU = "select *from datosusuarios  where IdDocumentodeIdentificacion_du=" + "'" + ndoc + "'";
        try {
            TSentenciaGuardarhc = con2.createStatement();
            ...
            if (objvalidarGHC.validarvisualTextField(gingresoPM.JFTPrimerApll) == 1) {
                ...
                if (objvalidarGHC.validarvisualTextField(gingresoPM.JFTSgdoApll)
                    ...
                    if (objvalidarGHC.validarvisualTextField(gingresoPM.JFTSgdoNbre)
                        ...
                        swval = 0;
                        if (objvalidarGHC.validarvisualTextField(gingresoPM.JFTFechaNac) == 1) {
                            objvalidarGHC.mensajeconfirmacion(
                            ...
                            swval = 0;
                            if (objvalidarGHC.validarvisualTextField(gingresoPM.JFTNHijos) == 1) {
                                objvalidarGHC.mensajeconfirmacion(
                                        "EL NUMERO DE HIJOS NO PUEDE ESTAR VACIO",
                                        "FECHA DE NACIMIENTO");
                                swval = 1;
                            } else { //cierra el if de la no hIJOS , 999999999999999999999
                                swval = 0;
                                if (objvalidarGHC.validarvisualTextField(gingresoPM.JFTDirResidencia) == 1) {
                                    objvalidarGHC.mensajeconfirmacion(
    ...
    public int actualizardatosusuarios(CIngreso gingresoPM) throws SQLException {
        ...
        Connection con2 = Cconsql.getConnection();
        int ver = 0, barriohc;
        String cadeps, sqleps, epshc, cadips, sqlips, ipshc, cadzona, sqlzona, zonahc, cadbarrio, sqlbarrio;
        cadzona = objvalidarGHC.evaluarcombocadena(gingresoPM.JCBZonRes);
        sqlzona = "select *from zona where zona.nombre_zona=" + "'" + cadzona + "'";
        zonahc = objvalidarGHC.buscarcadena(sqlzona, 1);
        cadbarrio = objvalidarGHC.evaluarcombocadena(gingresoPM.JCBBarrio);
    ...
    public int actualizaringreso(CIngreso gingresoPM) throws SQLException {
        ...
        try {
            System.out.println("ceci impr" + sqlcadingreso);
            TSentenciaGuardarhc = con2.createStatement();
            vardatoingreso = TSentenciaGuardarhc.executeUpdate(sqlcadingreso);
        }//cierra el try
        catch (SQLException e) {
    ...
    public int actualizaraf(CAntecedentesFamiliar frameantecendnetesfam) throws SQLException {
        ...
        try {
            if (frameantecendnetesfam.JCHHta.isSelected() || frameantecendnetesfam.JCHDiabet.isSelected() || frameantecendnetesfam.JCHCancer.isSelected() || frameantecendnetesfam.JCHCardiopatias.isSelected() || frameantecendnetesfam.JCHEpilepsia.isSelected() || frameantecendnetesfam.JCHOtros.isSelected()) {
    ...
    public int actualizariz(CInmuniz frameinmunuz) throws SQLException {
        int varinmuniz = 0;
        String sqlinmun;
        System.out.println("USUARIO NALGONA:" + frameinmunuz.JCHfa.isSelected());
        Connection con2 = Cconsql.getConnection();
        TSentenciaGuardarhc = con2.createStatement();
    ...
    public int actualizaroa(COtrosAnt frameotrosantecedentes) throws SQLException {
        ...
        try {
            if (frameotrosantecedentes.JCHLicor.isSelected() || frameotrosantecedentes.JCHOtros.isSelected() || frameotrosantecedentes.JCHPractDep.isSelected() || frameotrosantecedentes.JCHTabaco.isSelected()) {
...
class Cframesaludocupacional_JMGinecologia_actionAdapter implements
    ...
    Cframesaludocupacional_JMGinecologia_actionAdapter(Cframesaludocupacional adaptee) {
...
class Cframesaludocupacional_JMGineco_actionAdapter implements ActionListener {
    ...
    Cframesaludocupacional_JMGineco_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMAntecFam_actionAdapter implements ActionListener {
    ...
    Cframesaludocupacional_JMAntecFam_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMHistClinica_actionAdapter implements
    ...
    Cframesaludocupacional_JMHistClinica_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMRelacion_actionAdapter implements ActionListener {
    ...
    Cframesaludocupacional_JMRelacion_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMFactorRiesg_actionAdapter implements
    ...
    Cframesaludocupacional_JMFactorRiesg_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMAccTrabajo_actionAdapter implements
    ...
    Cframesaludocupacional_JMAccTrabajo_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMEnfProf_actionAdapter implements ActionListener {
    ...
    Cframesaludocupacional_JMEnfProf_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMIngrAlt_actionAdapter implements ActionListener {
    ...
    Cframesaludocupacional_JMIngrAlt_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMIngrOsteomus_actionAdapter implements
    ...
    Cframesaludocupacional_JMIngrOsteomus_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMReingreso_actionAdapter implements
    ...
    Cframesaludocupacional_JMReingreso_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMEscolaridad_actionAdapter implements
    ...
    Cframesaludocupacional_JMEscolaridad_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMECIVIL_actionAdapter implements ActionListener {
    ...
    Cframesaludocupacional_JMECIVIL_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMEdicion_actionAdapter implements java.awt.event.ActionListener {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMEdicion_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMReimprimir_actionAdapter implements java.awt.event.ActionListener {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMReimprimir_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMImc_actionAdapter implements java.awt.event.ActionListener {
...
class Cframesaludocupacional_JMLateralidad_actionAdapter implements java.awt.event.ActionListener {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMLateralidad_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMTratamiento_actionAdapter implements java.awt.event.ActionListener {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMTratamiento_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMPatologias_actionAdapter implements java.awt.event.ActionListener {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMPatologias_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMParaclinicos_actionAdapter implements java.awt.event.ActionListener {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMParaclinicos_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMFactRiesg_actionAdapter implements
    ...
    Cframesaludocupacional_JMFactRiesg_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMINmuniz_actionAdapter implements java.awt.event.ActionListener {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMINmuniz_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMHabit_actionAdapter implements java.awt.event.ActionListener {
...
class Cframesaludocupacional_JMPeriodico_actionAdapter implements java.awt.event.ActionListener {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMPeriodico_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_jMenu1_actionAdapter implements java.awt.event.ActionListener {
...
class Cframesaludocupacional_JMIngApto_actionAdapter implements java.awt.event.ActionListener {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMIngApto_actionAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
...
class Cframesaludocupacional_JMRetiroRep_mouseAdapter extends java.awt.event.MouseAdapter {

    private Cframesaludocupacional adaptee;

    Cframesaludocupacional_JMRetiroRep_mouseAdapter(Cframesaludocupacional adaptee) {
        this.adaptee = adaptee;
    }
