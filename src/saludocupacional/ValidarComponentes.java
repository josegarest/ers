...
public class ValidarComponentes {
    ...
    public int validardigitosnuevo(KeyEvent e, JFormattedTextField rr) {
        e.consume();
        int i = 0;
    ...
    public void llenarcombos(String cadena, JComboBox JCBOperador, int numcolumna) {
        try {
            ...
            ex.printStackTrace();
            System.out.println("problema en la consulta de llenar combos del modulo de todos los pedidos");
        }
    ...
    public String cambiarformatofecha(String cadenafecha) {
        ...
        String cad2;
        String cad3;
        StringBuffer cadtemporal = new StringBuffer(cadenafecha);
    ...
    public void llenarcombosenteros(String cadena, JComboBox JCBOperador, int numcolumna) {
        try {
            ...
            ex.printStackTrace();
            System.out.println("problema en la consulta de llenar combos enteros del modulo de todos los pedidos");
        }
        Conxcelda.CerrarConexion();
    ...
    public int tamanoconsulta(ResultSet Rvarentrada) {
        ...
        try {
            ...
            mensajeconfirmacion("ERROR", "PROBLEMA EN CALCULAR EL TAMAÑO DE LA CONSULTA");
        }
        Conxcelda.CerrarConexion();
        return (tam + 1);
    }
    ...
    public void validarfecha(String fechamodelo) {
        ...
        if (fechamodelo == null) {
            ...
            if (caddia.compareTo("  ") == 0 || cadmes.compareTo("  ") == 0 || cadano.compareTo("    ") == 0) {
                mensajeconfirmacion("EL DIA O EL MES O EL AÑO NO PUEDEN ESTAR EN BLANCO", "ERROR FECHA");
                swfechavalida = 1;
            } //CIERRA EL IF DEL DIA,MES,AÑO NULL
                ...
                else if (iano < 1800 || iano > 2100) {
                    mensajeconfirmacion("EL AÑO DIGITADO NO ES VALIDO PARA EL AÑO", "ERROR AÑO");
                    swfechavalida = 1;
                }//CIERRA EL ELSE DEL AÑO//CIERRA EL ELSE DEL MES//CIERRA EL ELSE DEL DIA
            }//CIERRA EL ELSE DEL DIA,MES,AÑO NULL
