...
class CHistoriaOcup_JBEpilepsia_actionAdapter implements ActionListener {
    ...
    CHistoriaOcup_JBEpilepsia_actionAdapter(COtrosAnt adaptee) {
        this.adaptee = adaptee;
    }
